...
<%block name="references">
    <%bflib:reference title="My notes on git configuration" url="https://bitflippin.com/article/arch-google-chrome/">Installation instructions and setting some basic properties. Lumped together with notes on installing other packages on Arch Linux.</%bflib:reference>
    <%bflib:reference title="Github on adding ssh keys" url="https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account">Explanation of how github uses ssh keys. Detailed instructions on how to create them and add them to a github account.</%bflib:reference>
</%block>