...
<%block name="article">
    <p>asdf content!</p>
    <%gallery:gallery fn="time-release-lock-charging-port" fid="00000003" x="1650", y="2150", width="1500", angle="150">
    ...
    <%gallery:gallery fn="time-release-lock-timer" fid="00000004" x="0", y="200", width="3000", angle="0">
    ...
    <%gallery:gallery fn="toolbox-of-chocolate" fid="00000005" x="0", y="1150", width="2980", angle="0">
    ...
    <%gallery:gallery fn="open-time-release-lock" fid="00000006" x="1000", y="1020", width="2900", angle="75">
