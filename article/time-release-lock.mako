...
<%block name="article">
    ...
    <p>I buy anything I like and can find at an acceptable price. Some of my favorite sugary snacks are <a href="https://www.ferrerorocher.com/">Ferrero Rocher</a>, extra dark chocolate baking chips, and <a href="https://sanderscandy.com/products/original-dark-chocolate-sea-salt-caramels-tub-32-oz">Sanders Sea Salt Caramels</a>! I keep them all in one container. Any container with a hole for the shackle of the lock to slip through will do, but I use a large repurposed toolbox. I had it on-hand, and it allows me lots of space.</p>

    <p>In the morning, I enjoy choosing a reasonable amount of junk food from the container to last me the day. I give myself plenty of leeway about what <em>reasonable</em> means. After all, I only want to avoid overindulgence, not to punish myself. After that I make my commitment by locking the container.</p>
