...
<%block name="article">
    <p>Arch is about building a system from the ground up, adding and configuring one small piece at a time. It is a fun hobby, but like any hobby, it is also something of a time sink - especially considering the availability of high quality ready-to-use Linux distributions out there. The process I present here documents my personal journey and learning. It is a patchwork of building blocks captured and customized from around the internet. I usually include links along the way for attribution and further reading.</p>
